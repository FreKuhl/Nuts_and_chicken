...
model_function <- function(){
  ...
  # Der Ertrag von den Haselnüssen wurde ja schon mit gompertz() simuliert, jetzt will ich aber die Wahrscheinlichkeit, dass
  # der Ertrag durch ein Spätfrostereignis ausfällt simulieren. Also einzelne Jahre mit 10%iger Wahrscheinlichkeit auf 0 setzen
  # value_if und value_if_not müssen aber die gleiche Länge haben
  ...
  final_maintenance <- maintaining_trees_final + maintaining_fences_final + maintaining_chicken_mobile_final +
    replacing_cicken_final + replacing_trees_final + feed_final + nut_harvest_cost_final
