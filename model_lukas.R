...
model_function <- function() {
  ...
  initial_investments <-
    grass_planting_cost + initial_fences_cost + machinery
  ...
  general_investments <-
    initial_investments + Reduce("+", maintaining_fences) # Final value of this chapter
  ...
  nut_fertilizer_cost <- sum(vv(
    var_mean = nut_fertilizer,
    var_CV = 30,
    n = years
  ))
